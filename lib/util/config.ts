...
class Config {
	...
	static get instance() {
		...
		const default_path = existsSync(resolve(this.path, `./default.ts`)) ? resolve(this.path, `./default.ts`) : resolve(this.path, `./default.js`);
		const config_path = existsSync(resolve(this.path, `./${process.env.NODE_ENV}.ts`)) ? resolve(this.path, `./${process.env.NODE_ENV}.ts`) : resolve(this.path, `./${process.env.NODE_ENV}.js`);;
